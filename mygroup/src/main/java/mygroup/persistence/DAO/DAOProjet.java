            ...
            if (projet != null) {
                ...
                if (taches != null) {
                    for (String tache : taches) {
                        MongoCollection<Document> collection2 = DBConnection.getInstance().getDatabase()
                ...
                if (seances != null) {
                    for (@SuppressWarnings("unused")
                    String seance : seances) {
                        // MongoCollection<Document> collection3 =
                        // DBConnection.getInstance().getDatabase().getCollection("seances");

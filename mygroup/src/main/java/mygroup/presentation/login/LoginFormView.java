...
public class LoginFormView extends Application {
    ...
    private void Initialiser() {
        ...
        logoView = createImageView("file:./mygroup/src/main/java/Pictures/Logo-Ensa.png", 80, 50);
        logoBox = createVBox(10, Pos.TOP_LEFT, logoView);
        welcomeView = createImageView("file:./mygroup/src/main/java/Pictures/welcome.png", 350, 140);
